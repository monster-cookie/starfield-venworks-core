...
Event OnQuestInit()
  ...
  LogUser(creationName=Venworks_ModName, moduleName="PlayerLevelHandlerScript", functionName="OnQuestInit", logMessage="OnQuestInit triggered. Initializing PlayerLevel AV to player's current level.", severity=severityTable.Info)
...
Event OnStoryIncreaseLevel(int aiNewLevel)
  LogSeverity severityTable = new LogSeverity;
  LogUser(creationName=Venworks_ModName, moduleName="PlayerLevelHandlerScript", functionName="OnStoryIncreaseLevel", logMessage="OnStoryIncreaseLevel SM Event triggered. Updating PlayerLevel AV to player's current level.", severity=severityTable.Info)
  Game.GetPlayer().SetValue(PlayerLevel, Game.GetPlayerLevel() as Float)
  Self.Stop()
endEvent
